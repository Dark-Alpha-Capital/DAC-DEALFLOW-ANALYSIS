-- Idempotent duplicate of 0027: drizzle-kit had regenerated WorkflowJob DDL without IF NOT EXISTS,
-- which breaks migrate when 0027 already created the table. Safe to run after 0027.
