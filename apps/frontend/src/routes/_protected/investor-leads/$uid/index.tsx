...
function InvestorLeadDetailRoute() {
  ...
  if (error) {
    return (
      <DetailPageError
        title="Error loading"
        message="There was an error loading the investor lead."
        backTo="/investor-leads"
        backLabel="Back to Investor Leads"
      />
    );
  }
  ...
  if (!data || !data.lead) {
    return (
      <DetailPageNotFound
        message="This investor lead does not exist or has been removed."
        backTo="/investor-leads"
        backLabel="Back to Investor Leads"
      />
    );
