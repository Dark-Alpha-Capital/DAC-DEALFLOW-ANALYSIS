        ...
        <div className="container relative z-10 mx-auto px-4 py-24 sm:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Button
                className="transform rounded-full px-8 py-6 font-semibold shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-ring focus:ring-opacity-75"
                asChild
              >
                <Link href="/raw-deals">
                  Explore Raw Deals
