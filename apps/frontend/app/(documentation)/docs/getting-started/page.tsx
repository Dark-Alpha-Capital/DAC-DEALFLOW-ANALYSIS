    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          <Link href="/docs/leads" className="rounded border px-3 py-1.5 hover:bg-accent">Leads</Link>
          <Link href="/docs/deals" className="rounded border px-3 py-1.5 hover:bg-accent">Deals pipeline</Link>
          <Link href="/docs/companies" className="rounded border px-3 py-1.5 hover:bg-accent">Companies</Link>
          <Link href="/docs/screenings" className="rounded border px-3 py-1.5 hover:bg-accent">Screenings</Link>
          <Link href="/docs/analytics" className="rounded border px-3 py-1.5 hover:bg-accent">Analytics</Link>
        </div>
      </section>
    </div>
  );
