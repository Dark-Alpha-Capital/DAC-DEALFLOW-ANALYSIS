/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1ac82ca1210b7629cb678a426a40797e)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AUTH_SECRET: string;
		GTM_LEADS_API_KEY: string;
		DATABASE_URL: string;
		RESEND_API_KEY: string;
		NEXTCLOUD_URL: string;
		NEXTCLOUD_USER: string;
		NEXTCLOUD_PASSWORD: string;
		SCREEN_DEAL_WORKFLOW: Workflow<Parameters<import("./src/server").ScreenDealWorkflow['run']>[0]['payload']>;
		FILE_UPLOAD_WORKFLOW: Workflow<Parameters<import("./src/server").FileUploadWorkflow['run']>[0]['payload']>;
		CIM_EXTRACTION_WORKFLOW: Workflow<Parameters<import("./src/server").CimExtractionWorkflow['run']>[0]['payload']>;
		...
		PROJECT_KICKOFF_SCREEN_WORKFLOW: Workflow<Parameters<import("./src/server").ProjectKickoffScreenWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REDIS_URL" | "AI_API_KEY" | "BITRIX_SECRET_KEY" | "BLOB_READ_WRITE_TOKEN" | "BITRIX24_WEBHOOK" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "GOOGLE_AI_API_KEY" | "VITE_PUBLIC_APP_URL" | "NEXT_PUBLIC_APP_URL" | "AUTH_SECRET" | "GTM_LEADS_API_KEY" | "DATABASE_URL" | "RESEND_API_KEY" | "NEXTCLOUD_URL" | "NEXTCLOUD_USER" | "NEXTCLOUD_PASSWORD">> {}
}
