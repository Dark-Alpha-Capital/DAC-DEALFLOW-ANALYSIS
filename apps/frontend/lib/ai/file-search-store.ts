 ...
 *
 * @param fileSearchDocumentName The full document name path (e.g., 'fileSearchStores/companyduediligencedocument-7b631nrhb99k/documents/humza-resume-wnf16gxlad8r')
